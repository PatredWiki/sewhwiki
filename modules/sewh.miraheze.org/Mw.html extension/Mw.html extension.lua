--[[
    ...
    Module:Mw.html extension is sourced from the RuneScape Wiki.
    Check it out:

    https://runescape.wiki/w/Module:Mw.html_extension
...
function mwHtml:addCss( css )
    if not css then return self end

    if is( css, "string" ) then
        return self:cssText( css )
